...
// 	node_t		*end;
// 	int			size;
// 	void		(*push_back)(list_t *self, int data, size_t size);
// 	void		(*push_front)(list_t *self, int data, size_t size);
...
// void				ft_list_push_back(list_t *lst, int data, size_t size);

// void				ft_list_pop_front(list_t *lst);

// void				ft_list_pop_back(list_t *lst);

// void				ft_list_push_front(list_t *lst, int data, size_t size);
...
// node_t				*ft_node_constructor(int data, size_t size);
